...
import chromecon from 'images/favicon-196x196.png';
import applecon from 'images/apple-touch-icon-152x152.png';
import mscon from 'images/mstile-144x144.png';
...
const config = {
  link: [
    ...
    { rel: 'stylesheet', href: 'https://bootswatch.com/3/flatly/bootstrap.min.css'}
  ...
  meta: [
    ...
    { name: 'description', content: 'Assista e interaja com as Lives do Space Today' },
